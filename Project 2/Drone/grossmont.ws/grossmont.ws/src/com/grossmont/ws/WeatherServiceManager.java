...
public class WeatherServiceManager{
    ...
    public static void main(String[] args){
        ...
        WeatherServiceManager wsm1 = new WeatherServiceManager();
        WeatherServiceManager wsm2 = new WeatherServiceManager();
        ...
        wsm1.callWeatherWebService(sCity1);
        wsm2.callWeatherWebService(sCity2);
        ...
        if (wsm1.getCurrentTemp() > wsm2.getCurrentTemp()) {
            System.out.println(wsm1.getCityName() + "has the higher current temperature");
        } else {
            System.out.println(wsm2.getCityName() + "has the higher current temperature");
        }

        if (wsm1.getHighTemp() - wsm1.getLowTemp() > wsm2.getHighTemp() - wsm2.getLowTemp()) {
            System.out.println(wsm1.getCityName() + "has the greater temperature range");
        } else {
            System.out.println(wsm2.getCityName() + "has the greater temperature range");
        }
